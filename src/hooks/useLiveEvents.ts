...
export function useLiveEvents(sportId: number, date?: Date): UseLiveEventsReturn {
  ...
  useEffect(() => {
    ...
    console.log('⏰ Configurando atualização automática dos eventos ao vivo...');
    ...
    return () => {
      ...
      console.log('⏹️ Parando atualização automática dos eventos ao vivo');
    };
  }, [sportId, refreshLiveEvents]);
